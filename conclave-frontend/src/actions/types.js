...
export const VOTE_THREAD_REQUEST = 'VOTE_REQUEST';
export const VOTE_THREAD_SUCCESS = 'VOTE_SUCCESS';
export const VOTE_THREAD_FAILURE= 'VOTE_ERROR';
export const VOTE_POST_REQUEST = 'VOTE_REQUEST';
export const VOTE_POST_SUCCESS = 'VOTE_SUCCESS';
export const VOTE_POST_FAILURE = 'VOTE_ERROR';
